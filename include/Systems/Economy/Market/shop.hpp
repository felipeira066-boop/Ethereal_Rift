#pragma once
#include <iostream>
#include "include/assets/NPCs/NPCs-City/Merchanters.hpp"
#include "include/character/Classes/allClasses.hpp"
   ...
   protected:
      ...
      void LightWeapons(){
         ...
         switch (op) {
            ...
            case 2:
               if(CurrentCoin > 60){
                  if(cacador.equipar(hunter_ArmamentID::APRENTICE_KNIVES) == false) {
                     cout << "  > Você não é um caçador\n"; 
                     cin.ignore();
                     LightWeapons();
                     return;
            ...
            case 3:
               if(CurrentCoin > 90){
                  if(cacador.equipar(hunter_ArmamentID::OLD_GUN) == false) {
                     cout << "  > Você não é um caçador\n"; 
                     cin.ignore();
                     LightWeapons();
                     return;
